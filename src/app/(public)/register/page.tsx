...
// Refactored: uses AuthFormWrapper, AppButton, AppTextField, and a styles object.
// Compare to the old version — JSX is now half the length and much more readable.
